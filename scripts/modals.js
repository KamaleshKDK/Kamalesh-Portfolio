function closeModal(e) {
    e.target === closeBtn1 ? modal1.style.display = "none" : e.target === closeBtn2 ? modal2.style.display = "none" : e.target === closeBtn3 ? modal3.style.display = "none" : e.target === closeBtn4 ? modal4.style.display = "none" : e.target === closeBtn5 ? modal5.style.display = "none" : e.target === closeBtn6 && (modal6.style.display = "none"),
        headerIndex.style.zIndex = "1000",
        slidesIndex.style.zIndex = "4",
        scrollIndex.style.zIndex = "100"
} function openModal(e) {
    e.target === modalBtn1 ? modal1.style.display = "block" : e.target === modalBtn2 ? modal2.style.display = "block" : e.target === modalBtn3 ? modal3.style.display = "block" : e.target === modalBtn4 ? (document.getElementById("modal-content4").style.left = "63%",
        modal4.style.display = "block") : e.target === modalBtn5 ? (document.getElementById("modal-content5").style.left = "63%",
            modal5.style.display = "block") : e.target === modalBtn6 && (document.getElementById("modal-content6").style.left = "63%",
                modal6.style.display = "block"), headerIndex.style.zIndex = "0",
        slidesIndex.style.zIndex = "0", scrollIndex.style.zIndex = "-1"
} function outsideClick(e) {
    e.target === modal1 ? (modal1.style.display = "none",
        headerIndex.style.zIndex = "1000",
        slidesIndex.style.zIndex = "4",
        scrollIndex.style.zIndex = "100") : e.target === modal2 ? (modal2.style.display = "none",
            headerIndex.style.zIndex = "1000",
            slidesIndex.style.zIndex = "4",
            scrollIndex.style.zIndex = "100") : e.target === modal3 ? (modal3.style.display = "none",
                headerIndex.style.zIndex = "1000",
                slidesIndex.style.zIndex = "4",
                scrollIndex.style.zIndex = "100") : e.target === modal4 ? (modal4.style.display = "none",
                    headerIndex.style.zIndex = "1000",
                    slidesIndex.style.zIndex = "4",
                    scrollIndex.style.zIndex = "100") : e.target === modal5 ? (modal5.style.display = "none",
                        headerIndex.style.zIndex = "1000",
                        slidesIndex.style.zIndex = "4",
                        scrollIndex.style.zIndex = "100") : e.target === modal6 && (modal6.style.display = "none",
                            headerIndex.style.zIndex = "1000",
                            slidesIndex.style.zIndex = "4",
                            scrollIndex.style.zIndex = "100")
